...

{
  ...
  const tickets = [
    {
      id: 1,
      subject: "new ticket",
      describe: "its a new ticket",
      complete: true,
      created_at: "2020, 20, 02",
    },
    {
        id: 2,
        subject: "second ticket",
        describe: "its a second ticket",
        complete: false,
        created_at: "2020, 20, 02",
      },
  ]; 
  ...
  // const {
  //   mutate: reqComplateTicket,
  //   isLoading: closeTicketLoading,
  // } = useMutation(gate.complateTicket);
          ...
          <div className="py-3 bottom-0 sticky bg-c-secondary-900">
            ...
            >
              <textarea
                ...
                style={{ resize: "none" }}
                className={`p-2 hide-scrollbar min-h-10 text-sm bg-c-secondary-800 w-9/12 outline-none`}
                // placeholder={
                //   errors?.text ? errors?.text?.message : "Your reply"
                // }
              />
