...
export const errorPagesConfigs = [
  ...
  },
  {
    ...
    routes: [
      {
        path: `${process.env.PUBLIC_URL}/error-pages/error-500`,
  ...
  },
  {
    ...
    routes: [
      {
        path: `${process.env.PUBLIC_URL}/error-pages/coming-soon`,
  ...
  },
  {
    ...
    routes: [
      {
        path: `${process.env.PUBLIC_URL}/error-pages/maintenance`,
